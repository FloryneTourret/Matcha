...
<form action="Recherche" method="post" class="col-md-8 mx-auto" style="margin-top:5vh;">
    ...
    <div class="form-row">
        <div class="form-group col">
            <label for="formGroupExampleInput">Distance autour de moi (en km)</label>
    ...
    <div class="form-row">
        <div class="form-row">
            <div class="form-group col">
                ...
                <input type="number" name="min_pop" class="form-control" id="formGroupExampleInput" min="18" placeholder="<?php echo $_SESSION['user']['age'] - 2 ?>">
            </div>
            <div class="form-group col">
                <label for="formGroupExampleInput">Popularité maximum</label>
                <input type="number" name="max_pop" class="form-control" id="formGroupExampleInput" min="18" placeholder="<?php echo $_SESSION['user']['age'] + 2 ?>">
            </div>
        </div>
    </div>
    <div class="form-group">
    ...
    <button type="submit" class="btn btn-primary mb-4" style="background-color: #EF6461; color: black; border: none">Submit</button>
</form>
