...
--
-- Hôte : mysql
-- Généré le :  mer. 29 mai 2019 à 08:25
...
--
-- Structure de la table `discution_messages`
--

CREATE TABLE `discution_messages` (
...
(57, 'assets/upload/ftourret/8da4b0db65d61218.jpg', 2, '2019-05-29 08:18:43');
...
(1, 'Frédéric', 'LEONARD', '1997-08-12', 1, 5, 'lettoh', 'lettoh08@gmail.com', 'Je suis Fred. Je ne suis pas non binaire. Entièrement Homme. Avec un pénis quoi.', '', '2019-05-28 18:05:15', '$2y$10$N9eet7EhGZfqNr5ZNb5k9eVy4BXIuxmcVP/4xD5NFUsv/pL.JABjS', 1, 1, 1, 2.3527, 48.8543, 'Hôtel de Ville, Quai de l\'Hôtel de ville, 75004 Paris, France', 'Paris', 'France', 1, NULL, NULL),
(2, 'Floryne', 'TOURRET', '1998-12-04', 2, 1, 'ftourret', 'floryne.tourret@gmail.com', 'Design in art, is a recognition of the relation between various things, various elements in the creative flux. You can’t invent a design. You recognize it, in the fourth dimension. That is, with your blood and your bones, as well as with your eyes.', 'assets/upload/ftourret/8da4b0db65d61218.jpg', '2019-05-29 08:24:57', '$2y$10$iBDaoi5JQ7QKIIqLi.DWve3Qp6cAyx5PuUxGmoclQqhPl3rZ6MxsC', 1, 1, 1, 4.78405, 45.7582, '10 Avenue de Ménival, 69005 Lyon, France', 'Lyon', 'France', 0, NULL, NULL),
(3, 'Frédéric', 'LEONARD', '1997-08-12', 3, 4, 'lettard', 'frederic.leonard.pro@gmail.com', NULL, '', '2019-05-23 14:02:32', '$2y$10$LL173fJwQAKDxyx//q15BukDGX//c4x0Kzo4pkHYYZY0njcSNSwCS', 0, 1, 1, 2.3527, 48.8543, 'Hôtel de Ville, Quai de l\'Hôtel de ville, 75004 Paris, France', 'Paris', 'France', 0, NULL, NULL),
(4, 'Nathan', 'PUNCH MAN', '1995-08-02', 1, 2, 'napunchman', 'naplouvi@student.le-101.fr', 'How can there be too many typefaces in the world? Are there too many songs, too many books, too many places to go?', '', '2019-05-27 17:49:43', '$2y$10$biHqxwJhplQ0zjL6AV0tWe1Rp5B5gU0.8nXPGwTeSoCsJo3d/r7/q', 0, 1, 1, 2.3527, 48.8543, 'Hôtel de Ville, Quai de l\'Hôtel de ville, 75004 Paris, France', 'Paris', 'France', 1, NULL, NULL),
...
(9, 'Clarisse', 'KEITH', '1989-06-09', 2, 4, 'goldenbe', 'goldenbe@matcha.z4r7p1.fr', 'Entrepreneur. Troublemaker. Social media practitioner. Subtly charming twitter geek. Proud beer enthusiast. Bacon ninja. Web fan. Typical reader.', 'assets/upload/goldenbe/5cee3e34ddff9.jpg', '2019-05-29 08:09:25', '$2y$10$1YclqNh2YShCYyb7.5oAi.fKZ/WLZ3AtIwMcTeA/AWNY8kVSDuXTi', 0, 0, 1, 4.84999, 45.8528, '980 Rue de la République, 69250 Fleurieu-sur-Saône, France', 'Fleurieu-sur-Saône', ' France', 0, NULL, NULL),
...
(23, 'Nathalie', 'GRAHAM', '1984-11-06', 2, 2, 'brownfro', 'brownfro@matcha.z4r7p1.fr', 'Troublemaker. Unapologetic writer. Alcoholaholic. Pop culture junkie. Social media lover. Lifelong music advocate. Travel practitioner. Twitter guru.', 'assets/upload/brownfro/5cee3e82e716a.jpg', '2019-05-29 08:10:43', '$2y$10$CeR.O4jZ1iOQMH61Qz8VUOLi5bHS36yrP2mb64oqIPCAytpBWVJd6', 0, 0, 1, 4.85437, 45.7609, 'Tour Part-Dieu, 129 Rue Servient, 69003 Lyon, France', 'e Servient', ' 69003 Lyon', 0, NULL, NULL),
...
(28, 'Zoe', 'RANGEL', '1973-12-31', 3, 2, 'silverwo', 'silverwo@matcha.z4r7p1.fr', 'Freelance reader. Zombie lover. Troublemaker. Travel fan. Friend of animals everywhere. Extreme writer. Certified social media scholar.', 'assets/upload/silverwo/5cee3e8721f52.jpg', '2019-05-29 08:10:47', '$2y$10$BBas6ukGo.6OdSL6/zJr/.084J.yMPn0.F0K0f15QDwTTH2l5vrt2', 0, 0, 1, 4.7631, 45.7902, '8 Chemin des Serres, 69130 Écully, France', 'Écully', ' France', 0, NULL, NULL),
...
(32, 'Simon', 'VANCE', '1993-12-14', 1, 4, 'browngor', 'browngor@matcha.z4r7p1.fr', 'Entrepreneur. Troublemaker. Social media practitioner. Subtly charming twitter geek. Proud beer enthusiast. Bacon ninja. Web fan. Typical reader.', 'assets/upload/browngor/5cee3e94dc2f3.jpg', '2019-05-29 08:11:01', '$2y$10$a2DI/TEnlDsrW2Va5Qz60OTRp6fzRAkCymqS7Ozvfx7INlBAO4/Gu', 0, 0, 1, 4.62243, 45.7481, 'D50, 69670 Vaugneray, France', 'Vaugneray', ' France', 0, NULL, NULL),
...
(42, 'Remie', 'HENRY', '1997-09-14', 1, 4, 'Greentig', 'Greentig@matcha.z4r7p1.fr', 'Hardcore travel geek. Lifelong problem solver. Internet junkie. Creator. Thinker. Certified explorer.', 'assets/upload/Greentig/5cee3f486dbb6.jpg', '2019-05-29 08:14:00', '$2y$10$9KLLWiOLPNZLYp7EeagwKOjrvpZuwI11zkyVhUY4A8DaCvx7Ddl/6', 0, 0, 1, 4.62243, 45.7481, 'D50, 69670 Vaugneray, France', 'Vaugneray', 'France', 0, NULL, NULL),
...
(50, 'Didier', 'SOTO', '1986-04-06', 1, 3, 'Blackele', 'Blackele@matcha.z4r7p1.fr', 'Amateur beer guru. Certified pop culture practitioner. Evil music advocate. Food enthusiast.', 'assets/upload/Blackele/5cee3f515b928.jpg', '2019-05-29 08:14:09', '$2y$10$WY9as7hZhtaTa/VG2CauI.SwtdXCnbV8x4Hc3O7gvR/P8fZh1G40.', 0, 0, 1, 5.37368, 46.0229, '13 Chemin du Pré des Granges, 01640 Saint-Jean-le-Vieux, France', 'Saint-Jean-le-Vieux', 'France', 0, NULL, NULL),
...
(60, 'Rodney', 'BLEVINS', '1993-07-01', 1, 5, 'Happygoo', 'Happygoo@matcha.z4r7p1.fr', 'Music fanatic. Evil alcohol scholar. Lifelong communicator. Devoted beer practitioner. Tv lover.', 'assets/upload/Happygoo/5cee3f6c51525.jpg', '2019-05-29 08:14:36', '$2y$10$k/HFao2//DzHjyIZomGNaO/t7Z2bnz00d3kBgdUpsILqT2q7CHyGS', 0, 0, 1, 4.82571, 45.7583, '27 Rue du Doyenné, 69005 Lyon, France', 'Lyon', 'France', 0, NULL, NULL);
...
--
-- Structure de la table `user_discution`
--

CREATE TABLE `user_discution` (
  `discution_id` int(11) NOT NULL,
...
(2, 1, '2019-05-29 08:20:01'),
(2, 12, '2019-05-29 08:21:55'),
(2, 4, '2019-05-29 08:22:04');
...
--
-- Index pour la table `user_discution`
--
ALTER TABLE `user_discution`
  ADD PRIMARY KEY (`discution_id`);
...
--
ALTER TABLE `pictures`
  MODIFY `picture_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
-- AUTO_INCREMENT pour la table `user_discution`
--
ALTER TABLE `user_discution`
  MODIFY `discution_id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
